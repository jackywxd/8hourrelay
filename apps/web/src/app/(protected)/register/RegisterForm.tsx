            ...
            <Form className="flex flex-col w-full justify-center gap-8 items-center">
              <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                ...
                <div className="sm:col-span-3">
                  <div className="flex flex-col items-center">
                    ...
                    <FieldItem label="First Name" required fieldName="firstName" />
                    <FieldItem label="Last Name" required fieldName="lastName" />
                    ...
                    <FieldItem label="Year of birth" required fieldName="birthYear" />
                    <FieldItem
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                ...
                <div className="sm:col-span-3">
                  <div className="flex flex-col items-center">
                    <div>
                      <FieldItem label="Name" fieldName="emergencyName" required/>
                    </div>
                    <FieldItem label="Phone" fieldName="emergencyPhone" required />
                  </div>
                </div>
              </div>
