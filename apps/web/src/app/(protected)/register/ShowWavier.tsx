      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            ...
            damages, costs, expenses, actions, and causes of action, whether in
            law or equity, in respect of death, injury, loss or damage to my
            person or property howsoever caused rising or to arise by reason of
            my participation in the said event, whether as a spectator,
            participant, competitor or otherwise, whether prior to, during or
            subsequent to the event, and notwithstanding the same may be been
            contributed to, or occasioned by, the negligence of any of the
            aforesaid.
          </AlertDialogDescription>
          <AlertDialogDescription>
          ...
          <AlertDialogDescription>
            By submitting this entry, I acknowledge having read, understood and
            agreed to the above waiver, release, and indemnity. I warrant that I
            am physically fit to participate in this event.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
